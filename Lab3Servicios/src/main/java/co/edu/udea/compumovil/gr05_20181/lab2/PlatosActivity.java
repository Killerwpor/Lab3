...
public class PlatosActivity extends AppCompatActivity {
    ...
    public EditText editTextBuscarPlato;
    public static RecyclerView recyclerViewPlato;
   public static RecyclerViewAdapterPlato adaptadorPlato;
    public static ResponsePlato plato;
    ...
    public void mostrarPlatos(final String Option) {
